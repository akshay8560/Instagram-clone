package akshay.kumar.instalite.Messages;
...
import akshay.kumar.instalite.Messages.Adapter.MessageAdapter;
import akshay.kumar.instalite.Messages.Model.Chat;
import akshay.kumar.instalite.Messages.Model.Users;
import akshay.kumar.instalite.Messages.Notification.Data;
import akshay.kumar.instalite.Messages.Notification.NotificationSender;
import akshay.kumar.instalite.Messages.Notification.Token;
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    Data data = new Data(fuser.getUid(), R.mipmap.ic_instalite_black12, username+":"+message, "New Message",
                            userid);
